		...
		AsyncTask<String, Void, Exception> task = new AsyncTask<String, Void, Exception>() {
			...
			protected void onPostExecute(Exception error) {
				...
				if (error == null) {
					...
					finish();
					// Mostra avviso.
					Toast.makeText(Compose.this, R.string.send_toast_success, Toast.LENGTH_SHORT).show();
				} else {
					// Mostra errore.
					if (error instanceof Server.UnknownRecipientException) {
						Toast.makeText(Compose.this, R.string.send_toast_unknown_recipient, Toast.LENGTH_LONG).show();
					} else {
						Toast.makeText(Compose.this, R.string.send_toast_error, Toast.LENGTH_SHORT).show();
					}
				}
			}
